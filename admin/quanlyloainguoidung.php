...
<html lang="en">
	...
	<body >
		...
		<div class="container-fluid">
			<div class="row">
				<div style="margin:0 auto;" id="bang4">
				...
				<form name="a" method="get" action="">
					...
					?>
					<span><input id="tr_sua<?=$i?>" onclick="ptloainguoidung(this.value)" type="button" value=<?=$i?>></span>
					
					<?php
					}
					else{
					?>
					<input id="tr_sua<?=$i?>" onclick="ptloainguoidung(this.value)" type="button" value=<?=$i?>>
		...
		<div class="container">
			<div class="row">
				<?php 
				  include_once('nhaploainguoidung.php')
				?>
			</div>
		</div>
		</body>
